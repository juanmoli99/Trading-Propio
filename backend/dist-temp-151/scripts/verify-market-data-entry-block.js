...
const service = new market_data_health_service_1.MarketDataHealthService(operationalState);
...
const healthyAllowed = service.isEntryBlocked() === false &&
...
const inconsistentDoesNotUseStaleUnavailableBlock = service.isEntryBlocked() === false;
const assertions = {
    ...
    INCONSISTENT_NOT_CLASSIFIED_AS_STALE_OR_UNAVAILABLE: inconsistentDoesNotUseStaleUnavailableBlock,
};
