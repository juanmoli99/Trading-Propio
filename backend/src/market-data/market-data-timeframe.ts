export type MarketDataTimeframeUnit = 'Min' | 'Hour' | 'Day' | 'Week' | 'Month';

export interface MarketDataTimeframe {
  readonly amount: number;
  readonly unit: MarketDataTimeframeUnit;
}

export function formatMarketDataTimeframe(
...
export function validateMarketDataTimeframe(
  timeframe: MarketDataTimeframe,
): void {
